    ...
    <Link to={`/stream/${id}`} className="group block">
      <div className="relative rounded-xl overflow-hidden bg-card border border-border hover-lift">
        ...
        <div className="relative aspect-video overflow-hidden">
          ...
          {/* Overlay */}
          <div className="absolute inset-0 bg-background/30 dark:bg-background/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        ...
        <div className="p-4">
          <div className="flex gap-3">
            ...
            <div className="relative flex-shrink-0">
              <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center ring-2 ring-border group-hover:ring-primary transition-all duration-300">
                <span className="text-sm font-bold text-foreground">{streamer.charAt(0)}</span>
              </div>
              {isLive && (
